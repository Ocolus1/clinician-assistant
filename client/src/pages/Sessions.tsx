            ...
            <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4 overflow-hidden flex flex-col flex-grow">
              <div className="flex-grow overflow-auto pr-2">
                ...
                <TabsContent value="participants" className="space-y-4 mt-0">
                    ...
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem>
                          ...
                          <FormDescription>Select the client for this session</FormDescription>
                          <FormMessage />
                        </FormItem>
                      )}
                    />
                    ...
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem>
                          ...
                          <FormDescription>
                            {!selectedClientId ? "Select a client first" : "Select the primary therapist for this session"}
                          </FormDescription>
                          <FormMessage />
                        </FormItem>
                      )}
                  ...
                  <div className="mt-4">
                    <h3 className="text-sm font-medium mb-2">Additional Participants</h3>
                    <div className="border rounded-md p-4 bg-muted/20">
                      <p className="text-sm text-muted-foreground">
                        Additional participants can be added after creating the session in the Session Notes.
                      </p>
                    </div>
                  </div>
                </TabsContent>
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        ...
                        <FormControl>
                          <Textarea 
                            placeholder="Add any notes about session preparation, materials needed, or specific goals to focus on"
                        ...
                        <FormDescription>
                          These notes are for preparation only. Detailed session notes can be added after the session is completed.
                        </FormDescription>
                        <FormMessage />
                      </FormItem>
                    )}
                ...
                <div className="flex items-center mr-auto">
                  {activeTab !== "details" && (
                    <Button
                      type="button"
                      variant="outline"
                      onClick={() => setActiveTab(activeTab === "participants" ? "details" : "participants")}
                      className="mr-2"
                    >
                  ...
                  {activeTab !== "notes" && (
                    <Button
                      type="button"
                      onClick={() => setActiveTab(activeTab === "details" ? "participants" : "notes")}
                      variant="ghost"
                    >
                      Next
                    </Button>
